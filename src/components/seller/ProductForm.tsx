...
export function ProductForm({ product, onSubmit, onCancel }: ProductFormProps) {
  ...
  const handleSubmit = (values: ProductFormValues) => {
    const completeProductData: Product = {
      ...
      sellerId: product?.sellerId || "current_seller_id", // This should come from auth
      ...values,
      imageUrl: values.imageUrl || "https://placehold.co/300x200.png" // Default placeholder if empty
    };
