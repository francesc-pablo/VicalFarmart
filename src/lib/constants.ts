...
export const GHANA_REGIONS_AND_TOWNS: Record<string, string[]> = {
  ...
  "Bono East": ["Techiman", "Kintampo", "Nkoranza", "Atebubu", "Yeji", "Prang", "Busunya", "Amantin", "Ejura", "Kwame Danso", "Apesika", "Forikrom", "Jema", "Kajaji", "Kintampo North", "Kintampo South", "Nkoranza North", "Nkoranza South", "Pru East", "Pru West", "Sene East", "Sene West", "Techiman North", "Techiman South", "Tuobodom"],
  ...
  "Greater Accra": [
    "Accra", "Achimota", "Adabraka", "Adenta East", "Airport Residential Area", "Ablekuma", "Abokobi", "Abossey Okai",
    "Accra New Town", "Ada Foah", "Afienya", "Agbogba", "Amasaman", "Ashaiman", "Ashongman", "Awoshie",
    "Banana Inn", "Bortianor", "Bubiiashie", "Cantonments", "Circle", "Darkuman", "Dansoman", "Dodowa",
    "Dome", "Dzorwulu", "East Legon", "Gbawe", "Haatso", "James Town", "Kaneshie", "Kasoa (partly in Central)",
    "Katamanso", "Kisseiman", "Kokomlemle", "Korle Gonno", "Labadi", "Lapaz", "Lartebiokorshie", "Lashibi",
    "Legon", "Madina", "Makola", "Mallam", "Mamprobi", "McCarthy Hill", "Medie", "New Bortianor",
    "Nima", "North Kaneshie", "Nungua", "Odorkor", "Old Bortianor", "Osu", "Oyibi", "Pokuase", "Prampram",
    "Ringway Estates", "Roman Ridge", "Sakumono", "Santa Maria", "Sowutuom", "Spintex", "Sukura", "Taifa",
    "Tema", "Tema Community 1", "Tema Community 2", "Tema Community 25", "Tema New Town", "Teshie", "Tesano",
    "Tuba", "Usher Town", "Weija", "West Legon"
  ].sort(),
