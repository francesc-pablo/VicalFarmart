...
import { Mail, User as UserIcon, Briefcase, Building, Phone, MapPin, Globe, KeyRound, Truck } from 'lucide-react';
        ...
        <div className="md:col-span-1">
            <Card className="shadow-lg">
                <CardHeader className="items-center text-center">
                    ...
                    <CardTitle className="text-2xl">{userProfile.name || "Courier Name"}</CardTitle>
                    <CardDescription>Courier</CardDescription>
                </CardHeader>
            ...
            <Card className="shadow-lg">
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <InfoItem icon={Truck} label="Vehicle Type" value={userProfile.vehicleType} />
                        <InfoItem icon={Truck} label="Vehicle Registration" value={userProfile.vehicleRegistrationNumber} />
                    </div>
                    <Separator />
                    <InfoItem icon={MapPin} label="Business Address" value={userProfile.businessAddress} fullWidth />
                    <InfoItem icon={MapPin} label="Residential Address" value={userProfile.residentialAddress} fullWidth />
                </CardContent>
            </Card>
        </div>
      </div>
